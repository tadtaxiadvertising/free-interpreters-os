    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm mt-2 uppercase tracking-widest">Create Account</p>
        </div>
        ...
        <div className="glass rounded-3xl p-8 border border-white/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3 text-white font-semibold rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400`}
            >
              {isLoading ? (
                <>
