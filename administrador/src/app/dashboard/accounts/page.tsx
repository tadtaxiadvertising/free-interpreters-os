...
import { getVaultAccountsForCurrentInterpreter } from "@/app/actions/interpreter-vault";
import { RbacStatCard, RbacStatSkeleton } from "@/components/rbac-dashboard/stat-card";
import toast from "react-hot-toast";

export default function InterpreterAccountsPage() {
  ...
  const loadData = async () => {
    setLoading(true);
    getVaultAccountsForCurrentInterpreter()
      .then(setAccounts)
